package com.example.avayaod.controller;
...
public class Webservice {
	...
	@GetMapping("/accountUnlock")
	public JSONObject validateAccountUnlockDetails(@RequestParam(name="DOB", required=true, defaultValue="null") String dob,
			@RequestParam(name="EmpNo", required=true, defaultValue="null") String EmpNo)
	{
		JSONObject respObj = new JSONObject();
		
		if(dob.equalsIgnoreCase("22111990") && EmpNo.equalsIgnoreCase("1111"))
		{
	...
	public JSONObject returnPasswordReset(@RequestParam(name="DOB", required=true, defaultValue="null") String dob,
			@RequestParam(name="EmpNo", required=true, defaultValue="null") String EmpNo)
	{
